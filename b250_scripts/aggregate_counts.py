...
if len(sys.argv) >= 6:
    if sys.argv[5] == "non_coding":
        coding_only = False

prefix = "coding" if coding_only else "all"

outfile_rna = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/ribo_diff/{}_{}_{}.tsv".format(rna_id, sample1, sample2, prefix)
outfile_rp = "/icgc/dkfzlsdf/analysis/OE0532/{}/analysis/output/ribo_diff/{}_{}_{}.tsv".format(rp_id, sample1, sample2, prefix)
